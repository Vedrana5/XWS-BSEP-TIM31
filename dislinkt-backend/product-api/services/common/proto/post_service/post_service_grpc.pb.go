...
type PostServiceClient interface {
	...
	GetOffersByPosition(ctx context.Context, in *GetOfferRequest, opts ...grpc.CallOption) (*GetMultipleOfferResponse, error)
...
func (c *postServiceClient) GetOffersByPosition(ctx context.Context, in *GetOfferRequest, opts ...grpc.CallOption) (*GetMultipleOfferResponse, error) {
	out := new(GetMultipleOfferResponse)
	err := c.cc.Invoke(ctx, "/post_service.PostService/getOffersByPosition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PostServiceServer interface {
	...
	GetOffersByPosition(context.Context, *GetOfferRequest) (*GetMultipleOfferResponse, error)
...
func (UnimplementedPostServiceServer) GetOffersByPosition(context.Context, *GetOfferRequest) (*GetMultipleOfferResponse, error) {
...
func _PostService_GetOffersByPosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOfferRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PostServiceServer).GetOffersByPosition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/post_service.PostService/getOffersByPosition",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).GetOffersByPosition(ctx, req.(*GetOfferRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PostService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PostService_GetOffersByPosition_Handler,
		},
		{
