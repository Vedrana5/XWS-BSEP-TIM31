...
var file_post_service_proto_rawDesc = []byte{
	...
	0x22, 0x3f, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x05, 0x50, 0x6f, 0x73, 0x74, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x70, 0x6f, 0x73, 0x74, 0x5f, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x05, 0x50, 0x6f, 0x73, 0x74,
	...
	0x6e, 0x74, 0x73, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0xc7, 0x01, 0x0a, 0x0b, 0x50, 0x6f,
	...
	0x49, 0x64, 0x7d, 0x42, 0x22, 0x5a, 0x20, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x6d, 0x6f,
...
var file_post_service_proto_goTypes = []interface{}{
	(*GetMultipleResponse)(nil), // 0: post_service.GetMultipleResponse
	(*GetRequest)(nil),          // 1: post_service.GetRequest
	(*GetResponse)(nil),         // 2: post_service.GetResponse
	(*Post)(nil),                // 3: post_service.Post
}
var file_post_service_proto_depIdxs = []int32{
	3, // 0: post_service.GetMultipleResponse.Posts:type_name -> post_service.Post
	3, // 1: post_service.GetResponse.Post:type_name -> post_service.Post
	1, // 2: post_service.PostService.get:input_type -> post_service.GetRequest
	1, // 3: post_service.PostService.getAllByUsername:input_type -> post_service.GetRequest
	2, // 4: post_service.PostService.get:output_type -> post_service.GetResponse
	0, // 5: post_service.PostService.getAllByUsername:output_type -> post_service.GetMultipleResponse
