...
import { JobOfferPublish } from 'src/app/interfaces/jobOfferPublish-dto';
import { JobOfferWithPublisher } from 'src/app/interfaces/jobOfferWithPublisher-dto';
...
export class PublishJobOfferComponent implements OnInit {
  ...
  constructor(
    ...
    this.publishing = {} as JobOfferPublish;
